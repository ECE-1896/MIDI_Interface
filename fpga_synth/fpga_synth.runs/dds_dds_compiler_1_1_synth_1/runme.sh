...
HD_PWD='C:/Users/Matt/Documents/Vivado_Projects/MIDI_Interface/fpga_synth/fpga_synth.runs/dds_dds_compiler_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_dds_compiler_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_dds_compiler_1_1.tcl
