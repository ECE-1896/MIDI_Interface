...
HD_PWD='C:/Users/Matt/Documents/Vivado_Projects/MIDI_Interface/fpga_synth/fpga_synth.runs/dds_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dds_ila_0_0.tcl
