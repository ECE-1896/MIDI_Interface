...
architecture STRUCTURE of dds is
  component dds_dds_compiler_0_1 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component dds_dds_compiler_0_1;
  component dds_dds_compiler_1_1 is
  port (
    aclk : in STD_LOGIC;
    m_axis_phase_tvalid : out STD_LOGIC;
    m_axis_phase_tdata : out STD_LOGIC_VECTOR ( 15 downto 0 )
  );
  end component dds_dds_compiler_1_1;
  component dds_ila_0_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 15 downto 0 )
  );
  end component dds_ila_0_0;
  component dds_processing_system7_0_0 is
  port (
  ...
  end component dds_processing_system7_0_0;
  signal Net : STD_LOGIC;
  signal dds_compiler_0_m_axis_data_tdata : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal dds_compiler_1_M_AXIS_PHASE_TDATA : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal dds_compiler_1_M_AXIS_PHASE_TVALID : STD_LOGIC;
...
begin
dds_compiler_0: component dds_dds_compiler_0_1
     port map (
      aclk => Net,
      ...
      s_axis_phase_tdata(15 downto 0) => dds_compiler_1_M_AXIS_PHASE_TDATA(15 downto 0),
      s_axis_phase_tvalid => dds_compiler_1_M_AXIS_PHASE_TVALID
    );
dds_compiler_1: component dds_dds_compiler_1_1
     port map (
      aclk => Net,
      m_axis_phase_tdata(15 downto 0) => dds_compiler_1_M_AXIS_PHASE_TDATA(15 downto 0),
      m_axis_phase_tvalid => dds_compiler_1_M_AXIS_PHASE_TVALID
    );
ila_0: component dds_ila_0_0
     port map (
      clk => Net,
      probe0(15 downto 0) => dds_compiler_0_m_axis_data_tdata(15 downto 0)
    );
processing_system7_0: component dds_processing_system7_0_0
     port map (
