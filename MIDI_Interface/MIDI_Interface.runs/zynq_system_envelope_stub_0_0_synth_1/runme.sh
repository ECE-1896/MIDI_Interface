...
HD_PWD='C:/Users/Matt/Documents/Vivado_Projects/MIDI_Interface/MIDI_Interface/MIDI_Interface.runs/zynq_system_envelope_stub_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_system_envelope_stub_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_system_envelope_stub_0_0.tcl
