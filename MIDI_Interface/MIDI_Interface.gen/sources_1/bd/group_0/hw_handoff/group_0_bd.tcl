...
################################################################
# This is a generated script based on design: group_0
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.ASSOCIATED_RESET {rst:S_AXI_ARESETN} \
 ] $S_AXI_ACLK
  ...
  set note_frequency_0 [ create_bd_port -dir O -from 31 -to 0 note_frequency_0 ]
  ...
  connect_bd_net -net fifo_reader_0_note_frequency [get_bd_ports note_frequency_0] [get_bd_pins fifo_reader_0/note_frequency]
